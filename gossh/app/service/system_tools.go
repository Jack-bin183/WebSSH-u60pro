...
const devuiDefaultDir = "/data/plugins/DevUI"
const devuiBinaryName = "zte_topsw_devui.patched"
const devuiDownloadURL = "https://raw.githubusercontent.com/Primovist/WebSSH-u60pro/zte_topsw_devui/zte_topsw_devui.patched"
